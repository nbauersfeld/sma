...
- to prepare images with filtering to get better results (sharpen, blur, other kernels)
...
- how to get faster in clustering by implentational aspects (F mode in using of the Numpy library, data type conversion to float32 instead of float64, etc.)
