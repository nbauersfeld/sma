...
- to get an idea, how sample images are recorded, a schematic image description supports by (1) camera chassis, (2) mount to hold the (3) fiber channel and (4) reagence vessel with a given (5) reagent and sample, that is (6) enlighted by cameras flash light and recorded with (7) cameras foto diode

![aperture](doc/media/aperture.png)
